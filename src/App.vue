  ...
  <div class="music-player-container" :class="{ 'is-playing': isPlaying }">
    <div class="music-player">
      <div class="player-content-container">
        <h1 class="artist-name">Billie Eilish</h1>
        <!--  /.album-title -->
        <h3 class="song-title">{{ currentMusic.title }}</h3>
        <div class="time-container">
          <span style="margin-right: 10px;">{{ currentTime }}</span>
    ...
    <div class="album">
      ...
      <!--  /.album-art -->
      <div class="vinyl"
           :style="`background-image: url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/83141/vinyl.png'), url(${currentMusic.photo});`"></div>
      <!--  /.vinyl -->
    </div>
    <!--  /.album-art -->
  </div>
